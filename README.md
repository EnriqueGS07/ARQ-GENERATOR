...
- **Modelo recomendado**: `llama3.2:3b-instruct-q4_0` para balance entre velocidad y calidad
- **Tiempo de respuesta**: 30-120 segundos dependiendo del tamaño del repositorio
- **Repositorios grandes**: Máximo 100MB (configurable)
- **Persistencia**: Modelos de Ollama se mantienen entre reinicios del contenedor
